        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mb-16">
            <div className="flex items-center gap-4 mb-3">
              ...
              <span className="text-red-500 font-cond font-bold tracking-[0.3em] uppercase text-sm">Nosso Catálogo</span>
            </div>
            <h2 className="font-display text-6xl md:text-7xl text-white leading-none">
              NOSSOS <span className="text-red-500">PRODUTOS</span>
            </h2>
            <p className="text-gray-400 mt-4 max-w-xl">Material de construção certificado, direto da pedreira para a sua obra.</p>
          </div>
